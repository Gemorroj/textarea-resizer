...
window.addEventListener('DOMContentLoaded', function() {
  ...
  var markerWidth = 10, markerHeight = 10, markerTimeout = 1200, move = false, removeMarkerTimeout = 0, current = null, marker = null, config = {
  ...
  }, _docBody = document.body, _docElement = document.documentElement;
